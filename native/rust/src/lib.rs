...
use log::LevelFilter;
use modules::{valdi_hook, custom_font_hook, duplex_hook, fstat_hook, linker_hook, sqlite_hook, unary_call_hook, property_hook};
...
pub extern "system" fn JNI_OnLoad(_vm: JavaVM, _: *mut c_void) -> jint {
    ...
    env.register_native_methods(
        ...
        &[
            ...
            NativeMethod {
                name: "pushLaunderedPropertiesNative".into(),
                sig: "(Ljava/lang/String;)V".into(),
                fn_ptr: property_hook::push_laundered_properties as *mut c_void,
            },
            NativeMethod {
                name: "pushHiddenModulesNative".into(),
                sig: "(Ljava/lang/String;)V".into(),
                fn_ptr: property_hook::push_hidden_modules as *mut c_void,
            },
            NativeMethod {
                name: "pushPlatformOverrideNative".into(),
                sig: "(Ljava/lang/String;)V".into(),
...
extern "system" fn pre_init(_env: JNIEnv, _class: JObject) {
    ...
    for (name, init) in [
        ...
        ("property_hook", property_hook::init as fn()),
    ] {
