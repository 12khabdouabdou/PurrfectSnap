...
import me.eternal.purrfect.mapper.impl.CompositeConfigurationProviderMapper
...
class ConfigurationOverride : Feature("Configuration Override") {
    override fun init() {
        context.mappings.useMapper(CompositeConfigurationProviderMapper::class) {
            ...
            arrayOf("CUSTOM_AD_TRACKER_URL", "CUSTOM_AD_INIT_SERVER_URL", "CUSTOM_AD_SERVER_URL", "GRAPHENE_HOST").forEach {
