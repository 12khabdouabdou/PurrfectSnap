...
class BridgeService : Service() {
    ...
    var activeSortHookStatus: ActiveSortHookStatus = ActiveSortHookStatus.MAPPER_FAILED
    ...
    inner class BridgeBinder : BridgeInterface.Stub() {
        ...
        override fun setActiveSortHookStatus(status: String) {
            activeSortHookStatus = runCatching { ActiveSortHookStatus.valueOf(status) }.getOrDefault(ActiveSortHookStatus.MAPPER_FAILED)
        }

        override fun getActiveSortStatus(): String {
            return activeSortHookStatus.name
        }
    }
}
