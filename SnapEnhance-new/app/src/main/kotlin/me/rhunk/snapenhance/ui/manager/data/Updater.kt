...
object Updater {
    ...
    private fun fetchLatestDebugCI() = runCatching {
        val actionRuns = OkHttpClient().newCall(Request.Builder().url("https://api.github.com/repos/RSR1337/SnapEnhance/actions/runs?event=workflow_dispatch").build()).execute().use {
